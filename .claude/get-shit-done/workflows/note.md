...
- **Global scope**: `C:/Users/kenny/Desktop/POLYMARKET-WEATHER-BOT/.claude/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `C:/Users/kenny/Desktop/POLYMARKET-WEATHER-BOT/.claude/notes/`)
...
2. Glob `C:/Users/kenny/Desktop/POLYMARKET-WEATHER-BOT/.claude/notes/*.md` (if directory exists) — global notes
...
Global (C:/Users/kenny/Desktop/POLYMARKET-WEATHER-BOT/.claude/notes/):
...
2. **No `.planning/`**: Falls back to global `C:/Users/kenny/Desktop/POLYMARKET-WEATHER-BOT/.claude/notes/` — works in any directory
